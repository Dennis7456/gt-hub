#!/usr/bin/env python3
"""
Generate History of Taxation Learning Path
Converts history_of_taxation_learning_path.json into learning path files
"""
...
# Read the JSON file
with open('assets/history_of_taxation_learning_path.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

# Create output directory
output_dir = 'history-of-taxation/learning-path'
...
lessons_js = """// Lesson content for History of Taxation
...
<head>
  ...
  <title>History of Taxation - Learning Path</title>
  ...
  <header class="bg-white/10 backdrop-blur-md border-b border-white/20 sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <h1 class="text-white font-bold text-lg">History of Taxation</h1>
      </div>
      <div class="flex items-center gap-3">
        <!-- Hearts -->
...
print("\n✅ History of Taxation Learning Path generated successfully!")
print(f"📁 Files created in: {output_dir}/")
print(f"📊 {len(topics)} units with {sum(len(u['lessons']) for u in data['units'])} total lessons")
print("\n🎯 Open history-of-taxation/learning-path/index.html in a browser to start learning!")
