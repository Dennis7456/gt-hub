#!/usr/bin/env python3
"""
Generate Theory of Taxation Flashcards
Converts theory_of_taxation_flashcards.json into interactive flashcard app
"""
...
# Read the JSON file
print("Reading theory_of_taxation_flashcards.json...")
with open('assets/theory_of_taxation_flashcards.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

# Create output directory
output_dir = 'flashcards/theory-of-taxation'
...
# Copy app.js from tax-and-customs-theory (same structure)
print("Copying app.js...")
with open('flashcards/tax-and-customs-theory/app.js', 'r', encoding='utf-8') as f:
    app_js = f.read()

# Update localStorage key
app_js = app_js.replace("'taxCustomsTheoryFlashcards'", "'theoryOfTaxationFlashcards'")
...
<head>
  ...
  <title>Theory of Taxation - Flashcards</title>
...
<body>
  ...
  <header class="bg-white/10 backdrop-blur-md border-b border-white/20 sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
      <div>
        <h1 class="text-white font-bold text-xl">Theory of Taxation</h1>
...
# Create README
readme = f"""# Theory of Taxation - Flashcards

## Overview
Interactive flashcards for studying Theory of Taxation concepts.
...
- Types of taxes (income, consumption, excise, customs, stamp duties)
- Classification of taxes (direct vs indirect)
- Functions of taxation (revenue, social, political, economic, redistribution)
- Structural features of taxes
- Tax rate structures (proportional, progressive, regressive)
- Tax expenditures (incentives and concessions)
- Canons of taxation
- Principles of good tax policy
- Tax units and jurisdiction
- International taxation and DTAs
- Tax evasion, avoidance, and planning

## Study Tips

1. **First Pass**: Go through all cards to get familiar with concepts
2. **Category Focus**: Use filters to master one category at a time
3. **Shuffle Practice**: Test your knowledge with randomized cards
4. **Spaced Repetition**: Review cards multiple times over several days
...
print(f"\n✅ Theory of Taxation flashcards generated successfully!")
print(f"📁 Files created in: {output_dir}/")
print(f"📊 {len(data['flashcards'])} flashcards across {len(categories)} categories")
print("\n🎯 Open flashcards/theory-of-taxation/index.html in a browser to start studying!")
