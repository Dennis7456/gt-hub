#!/usr/bin/env python3
"""
Generate lesson content for Customs Valuation I learning path
"""
...
# Load flashcards
with open('assets/customs_valuation_i_flashcards.json', 'r') as f:
    flashcards_data = json.load(f)
    flashcards = flashcards_data.get('flashcards', [])

# Load learning path structure
with open('assets/customs_valuation_i_learning_path.json', 'r') as f:
...
# Save to JSON
output_path = 'customs-valuation-i/learning-path/lesson_content.json'
