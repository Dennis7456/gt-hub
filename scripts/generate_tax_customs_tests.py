#!/usr/bin/env python3
"""
Generate Tax and Customs Theory Tests
Converts tax_and_customs_theory_12_main_tests.json into test folders
"""
...
# Read the JSON file
print("Reading tax_and_customs_theory_12_main_tests.json...")
with open('assets/tax_and_customs_theory_12_main_tests.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

# Create output directory
output_dir = 'tax-and-customs-theory/tests'
...
<body class="min-h-screen">
  ...
  <header class="header-light backdrop-blur-sm sticky top-0 z-30 px-4 sm:px-6 py-3 sm:py-4">
    <div class="max-w-4xl mx-auto flex items-center justify-between">
      <div>
        <h1 class="text-base sm:text-lg font-semibold">Test {test_num}: Tax and Customs Theory</h1>
    ...
    <div id="start-screen" class="text-center py-12">
      <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
        ...
        <p class="text-slate-600 dark:text-slate-300 mb-6">
          This test contains {test['question_count']} multiple-choice questions on Tax and Customs Theory.
