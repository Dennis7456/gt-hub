#!/usr/bin/env python3
"""
Generate Customs in International Context flashcards from JSON data.
"""
...
def generate_flashcards_app(data, output_dir):
    ...
    # Generate cards.js
    cards_js = f"""// {topic}
// Auto-generated from customs_in_international_context_flashcards.json
...
def main():
    """Main function."""
    print("=" * 60)
    print("Generating Customs in International Context Flashcards")
    print("=" * 60)
    print()
    
    # Load data
    data = load_flashcards('assets/customs_in_international_context_flashcards.json')
    
    # Generate flashcards
    output_dir = 'flashcards/customs-in-international-context'
