#!/usr/bin/env python3
"""
Generate Tax and Customs Theory Learning Path
Converts tax_and_customs_theory_duolingo_path.json into learning path files
"""
...
# Read the JSON file
with open('tax-and-customs-theory/tax_and_customs_theory_duolingo_path.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

# Create output directory
output_dir = 'tax-and-customs-theory/learning-path'
...
def get_unit_icon(theme):
    icons = {
        ...
        'International Institutions': '🏛️',
        'Functions': '⚙️',
        'Border Management': '🛂',
        'Control Logic': '🎯',
        'Operational Control': '🔧',
        'Procedures': '📋',
        'Law and Instruments': '⚖️',
        'Future of Customs': '🚀'
    }
...
lessons_js = """// Lesson content for Tax and Customs Theory
...
<head>
  ...
  <title>Tax and Customs Theory - Learning Path</title>
  ...
  <header class="bg-white/10 backdrop-blur-md border-b border-white/20 sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <h1 class="text-white font-bold text-lg">Tax and Customs Theory</h1>
      </div>
      <div class="flex items-center gap-3">
        <!-- Hearts -->
...
# Copy app.js from clearance-one
print("Copying app.js...")
with open('clearance-one/learning-path/app.js', 'r', encoding='utf-8') as f:
    app_js = f.read()

# Update the localStorage key to be specific to tax-and-customs-theory
app_js = app_js.replace("'customsLearningProgress'", "'taxCustomsTheoryProgress'")
...
print("\n✅ Tax and Customs Theory Learning Path generated successfully!")
print(f"📁 Files created in: {output_dir}/")
print(f"📊 {len(topics)} units with {sum(len(u['lessons']) for u in data['units'])} total lessons")
print("\n🎯 Next steps:")
print("   1. Open tax-and-customs-theory/learning-path/index.html in a browser")
print("   2. The structure is complete with placeholder content")
print("   3. Lesson content can be expanded in lessons.js as needed")
