#!/usr/bin/env python3
"""
Generate Customs Valuation I flashcards from JSON data.
"""
...
def generate_flashcards_app(data, output_dir):
    ...
    # Generate cards.js
    cards_js = f"""// {topic}
// Auto-generated from customs_valuation_i_flashcards.json
...
def main():
    """Main function."""
    print("=" * 60)
    print("Generating Customs Valuation I Flashcards")
    print("=" * 60)
    print()
    
    # Load data
    data = load_flashcards('assets/customs_valuation_i_flashcards.json')
    
    # Generate flashcards
    output_dir = 'flashcards/customs-valuation-i'
