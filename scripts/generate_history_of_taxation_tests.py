#!/usr/bin/env python3
"""
Generate History of Taxation test HTML files from JSON data.
...
// Auto-generated from history_of_taxation_12_main_tests.json
...
def main():
    ...
    print("=" * 60)
    print("Generating History of Taxation Tests")
    print("=" * 60)
    
    # Load test data
    data = load_tests_data('assets/history_of_taxation_12_main_tests.json')
    ...
    output_dir = 'history-of-taxation/tests'
