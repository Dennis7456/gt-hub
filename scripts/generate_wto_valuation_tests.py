#!/usr/bin/env python3
"""
Generate WTO Customs Valuation test HTML files from JSON data.
...
// Auto-generated from wto_customs_valuation_12_main_tests.json
...
def main():
    ...
    print("=" * 60)
    print("Generating WTO Customs Valuation Tests")
    print("=" * 60)
    
    # Load test data
    data = load_tests_data('assets/wto_customs_valuation_12_main_tests.json')
    ...
    output_dir = 'wto-customs-valuation/tests'
