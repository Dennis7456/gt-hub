#!/usr/bin/env python3
"""
Generate Article VII Valuation Learning Path
Converts article_vii_valuation_learning_path.json into learning path files
"""
...
# Read the JSON file
with open('assets/article_vii_valuation_learning_path.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

# Create output directory
output_dir = 'article-vii-valuation/learning-path'
...
lessons_js = """// Lesson content for Article VII Valuation
...
<head>
  ...
  <title>Article VII Valuation - Learning Path</title>
  ...
  <header class="bg-white/10 backdrop-blur-md border-b border-white/20 sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <h1 class="text-white font-bold text-lg">Article VII Valuation</h1>
      </div>
      <div class="flex items-center gap-3">
        <!-- Hearts -->
...
print("\n✅ Article VII Valuation Learning Path generated successfully!")
print(f"📁 Files created in: {output_dir}/")
print(f"📊 {len(topics)} units with {sum(len(u['lessons']) for u in data['units'])} total lessons")
print("\n🎯 Open article-vii-valuation/learning-path/index.html in a browser to start learning!")
