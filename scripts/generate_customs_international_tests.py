#!/usr/bin/env python3
"""
Generate Customs in International Context test HTML files from JSON data.
...
// Auto-generated from customs_in_international_context_12_main_tests.json
...
def main():
    ...
    print("=" * 60)
    print("Generating Customs in International Context Tests")
    print("=" * 60)
    
    # Load test data
    data = load_tests_data('assets/customs_in_international_context_12_main_tests.json')
    ...
    output_dir = 'customs-in-international-context/tests'
