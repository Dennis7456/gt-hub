#!/usr/bin/env python3
"""
Generate Customs Valuation I test HTML files from JSON data.
...
// Auto-generated from customs_valuation_i_12_main_tests.json
...
def main():
    ...
    print("=" * 60)
    print("Generating Customs Valuation I Tests")
    print("=" * 60)
    
    # Load test data
    data = load_tests_data('assets/customs_valuation_i_12_main_tests.json')
    ...
    output_dir = 'customs-valuation-i/tests'
