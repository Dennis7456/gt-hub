#!/usr/bin/env python3
"""
Generate Theory of Taxation Learning Path
Converts theory_of_taxation_learning_path.json into learning path files
"""
...
# Read the JSON file
with open('assets/theory_of_taxation_learning_path.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

# Create output directory
output_dir = 'theory-of-taxation/learning-path'
...
lessons_js = """// Lesson content for Theory of Taxation
...
<head>
  ...
  <title>Theory of Taxation - Learning Path</title>
  ...
  <header class="bg-white/10 backdrop-blur-md border-b border-white/20 sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <h1 class="text-white font-bold text-lg">Theory of Taxation</h1>
      </div>
      <div class="flex items-center gap-3">
        <!-- Hearts -->
...
# Copy app.js from tax-and-customs-theory
print("Copying app.js...")
with open('tax-and-customs-theory/learning-path/app.js', 'r', encoding='utf-8') as f:
    app_js = f.read()

# Update the localStorage key
app_js = app_js.replace("'taxCustomsTheoryProgress'", "'theoryOfTaxationProgress'")
...
print("\n✅ Theory of Taxation Learning Path generated successfully!")
print(f"📁 Files created in: {output_dir}/")
print(f"📊 {len(topics)} units with {sum(len(u['lessons']) for u in data['units'])} total lessons")
print("\n🎯 Next steps:")
print("   1. Open theory-of-taxation/learning-path/index.html in a browser")
